...
JAVA_ARGS="$JAVA_ARGS -XX:+UnlockExperimentalVMOptions -XX:+UseCGroupMemoryLimitForHeap -Dcom.sun.management.jmxremote -noverify -Dmicronaut.env.deduction=false-Dmicronaut.env.deduction=false"
